...
public final class MediaType implements AcceptPredicate<MediaType> {
    ...
    /**
     * The media type {CHARSET_PARAMETER} parameter name.
     */
     ...
     * <p>
     * See <a href="https://github.com/opengeospatial/WFS_FES/issues/117#issuecomment-402188280">issue</a>
     */
    ...
    /**
     * A {@link MediaType} constant representing the {@code application/vnd.hotwire.turbo.stream} media type.
     */
    public static final MediaType APPLICATION_TURBO_STREAM;
    ...
    static {
        ...
        APPLICATION_TURBO_STREAM = new MediaType("application", "vnd.hotwire.turbo.stream");
        knownTypes.put("application/openmetrics-text", APPLICATION_OPENMETRICS);
    ...
    public static final class Builder {
        ...
        private final TreeMap<String, String> parameters = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
